...
% -------------------------------------------------------------------------
    ...
    switch(joint)
        ...
        case 'shoulder'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_WidowX_widowx_shoulder_joint_conf', 2, ...
                robot.vrep.simx_opmode_oneshot);
 
        case 'biceps'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_WidowX_widowx_biceps_joint_conf', 2, ...
                robot.vrep.simx_opmode_oneshot);  
        
        case 'forearm'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_WidowX_widowx_forearm_joint_conf', 2, ...
                robot.vrep.simx_opmode_oneshot);  

        case 'wrist'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_WidowX_widowx_wrist_joint_conf', 2, ...
                robot.vrep.simx_opmode_oneshot);
               
        case 'gripper'
            result = robot.vrep.simxSetIntegerSignal(robot.v_clientID, ...
                'Turtlebot2_WidowX_widowx_gripper_joint_conf', 2, ...
                robot.vrep.simx_opmode_oneshot);
